...
pub use context::{ErrorContext, ErrorContextBuilder, ContextualError};
...
pub enum BitNetErrorKind {
    ...
    Device { message: String, device_type: String },
    
    /// Memory allocation and management errors
    #[error("Memory error: {message}")]
    Memory { message: String, size: Option<usize>, operation: String },
    
    /// Tensor operation errors
    #[error("Tensor error: {message}")]
    Tensor { message: String, shape: Option<Vec<usize>>, dtype: Option<String> },
    
    /// Data conversion errors
    #[error("Conversion error: {message}")]
    Conversion { message: String, from_type: String, to_type: String },
    
    /// Metal/GPU specific errors
    #[error("Metal error: {message}")]
    Metal { message: String, operation: String, device_name: Option<String> },
    ...
    Configuration { message: String, parameter: Option<String> },
...
impl BitNetError {
    ...
    pub fn memory_info(&self) -> Option<(Option<usize>, &str)> {
        match &self.kind {
            BitNetErrorKind::Memory { size, operation, .. } => Some((*size, operation)),
            _ => None,
        }
    }
}
