...
mod metal_tests {
    ...
    fn test_shader_compiler_creation() {
        ...
        if let Ok(device) = device_result {
            ...
            assert!(compiler_result.is_ok(), "Failed to create shader compiler: {:?}", compiler_result.err());
...
mod non_metal_tests {
    ...
    fn test_unsupported_platform() {
        println!("Metal shader compilation tests skipped - not on macOS or Metal feature not enabled");
