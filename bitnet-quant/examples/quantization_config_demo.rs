...
fn demo_advanced_weight_config() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "  - Threshold factor: {:?}",
        weight_config.custom_threshold_factor
    );
...
fn demo_activation_config() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        ...
        activation_config.per_token
    );
    println!(
        "  - Moving average window: {}",
        activation_config.moving_average_window
    );
    println!(
        "  - Smooth quantization: {}",
        activation_config.smooth_quantization
    );
...
fn demo_config_builders() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "  - Learnable scales: {}",
        custom_weight_config.learnable_scales
    );
    println!("  - Weight decay: {:?}", custom_weight_config.weight_decay);
    println!(
        "  - Gradient clip: {:?}",
        custom_weight_config.gradient_clip
    );
