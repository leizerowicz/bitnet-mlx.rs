...
mod precision_controller_tests {
    ...
    fn test_precision_controller_creation() {
        ...
        assert_eq!(controller.get_current_state().precision, QuantizationPrecision::OneFiveFiveBit);
    }
    ...
    fn test_dynamic_precision_adjustment_high_error() {
        ...
        if let Some(adj) = adjustment {
            ...
            assert!(controller.get_current_state().precision != QuantizationPrecision::OneFiveFiveBit);
        }
    }
...
mod configuration_preset_tests {
    ...
    fn test_aggressive_controller_creation() {
        ...
        let controller = controller.unwrap();
        assert_eq!(controller.get_current_state().precision, QuantizationPrecision::OneBit);
    }
}
